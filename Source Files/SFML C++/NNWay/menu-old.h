...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->русскийToolStripMenuItem->Size = System::Drawing::Size(207, 40);
		...
		void InitializeComponentMainMenuRU(void)
		{
			...
			this->label4->Location = System::Drawing::Point(15, 353);
			this->label4->Size = System::Drawing::Size(236, 35);
			this->label4->Text = L"Алгоритм обучения:";
			// 
			// label6
			// 
			this->label6->Location = System::Drawing::Point(15, 436);
			...
			this->comboBox1->Location = System::Drawing::Point(22, 225);
			this->comboBox1->Size = System::Drawing::Size(422, 32);
			this->comboBox1->Text = L"(Выберете язык)";
			// 
			// comboBox2
			// 
			this->comboBox2->Items->Clear();
			...
			this->comboBox2->Location = System::Drawing::Point(22, 308);
			this->comboBox2->Size = System::Drawing::Size(422, 32);
			this->comboBox2->Text = L"(Выберете измерение)";
			// 
			// comboBox3
			// 
			this->comboBox3->Items->Clear();
			this->comboBox3->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"NEAT", L"Q-Learning" });
			this->comboBox3->Location = System::Drawing::Point(22, 393);
			this->comboBox3->Text = L"(Выберете алгоритм обучения)";
			// 
			// comboBox4
			// 
			this->comboBox4->Items->Clear();
			this->comboBox4->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"Обучение", L"Проверка" });
			this->comboBox4->Location = System::Drawing::Point(22, 474);
			this->comboBox4->Size = System::Drawing::Size(422, 32);
			this->comboBox4->Text = L"(Выберете режим)";
			// 
			// menu
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(11, 24);
		...
		System::Void Button1_Click(System::Object^ sender, System::EventArgs^ e)
		{
			if (page == Pages::MENU)
			{
				if (comboBox1->SelectedIndex == -1)
				{
					...
					else if (language == Languages::RU) MessageBox::Show("Ошибка, выберете язык");
				}
		...
		System::Void Button2_Click(System::Object^ sender, System::EventArgs^ e)
		{
			if (page == Pages::MENU)
			{
				if (comboBox2->SelectedIndex == -1)
				{
					...
					else if (language == Languages::RU) MessageBox::Show("Ошибка, выберете измерение");
				}
			...
			else if (mode == Modes::LEARN)
			{
				if (learning_algorithm == LearningAlgorythms::NEAT)
				{
					if (Convert::ToInt32(textBox1->Text) <= 0)
					{
						...
						else if (language == Languages::RU) MessageBox::Show("Ошибка, неверное число");
					}
					else
		...
		System::Void Button3_Click(System::Object^ sender, System::EventArgs^ e)
		{
			if (page == Pages::MENU)
			{
				if (comboBox3->SelectedIndex == -1)
				{
					...
					else if (language == Languages::RU) MessageBox::Show("Ошибка, выберете алгоритм обучения");
				}
			...
			else
			{
				...
				if (learning_algorithm == LearningAlgorythms::NEAT)
				{
					...
					if (!neat::map_loaded)
					{
						...
						else if (language == Languages::RU) MessageBox::Show("Ошибка, карта не загружена");
					}
					else if (neat::layers_quantity = 0)
					{
						if (language == Languages::EN) MessageBox::Show("Error, wrong layers number");
						else if (language == Languages::RU) MessageBox::Show("Ошибка, неверное число слоев");
					}
					...
					else if (neat::direction_array_size = 0)
					{
						...
						else if (language == Languages::RU) MessageBox::Show("Ошибка, неверный размер массива направлений");
					}
					else if (comboBox1->SelectedIndex == -1)
					{
						if (language == Languages::EN) MessageBox::Show("Error, chose action with neat::map");
						else if (language == Languages::RU) MessageBox::Show("Ошибка, выберете действие с картой");
					}
				...
				else if (learning_algorithm == LearningAlgorythms::QL)
				{
					...
					else if (ql::iterations == 0)
					{
						...
						else if (language == Languages::RU) MessageBox::Show("Ошибка, неверное число повторений");
					}
					else if (comboBox1->SelectedIndex == -1)
					{
						if (language == Languages::EN) MessageBox::Show("Error, chose action with neat::map");
